...
Como podemos ver la aplicación no funciona porque está esperando a conectarse a la bse de datos.

## Despliegue del backend

En este caso vamos a realizar dos despligues: uno con una base de datos *redis* como *master* y otra con *redis* como esclavo.
